...
tired, function receives command "Going home" and after that it receives number of final steps made. As result it prints on screen if Gabby 
reached her goal or not.
...
06. Cake
This function calculates the number of pieces that guests have taken before the cake is over. It receives dimensions of the cake - height
and width and then on every single line it receives number of taken pieces. Function stops until command "STOP" or until the cake is over.